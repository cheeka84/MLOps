...
# ----- mlflow: use a local folder inside the repo, not /content -----
mlruns_dir = Path(os.getenv("MLFLOW_DIR", "mlruns")).resolve()
mlruns_dir.mkdir(parents=True, exist_ok=True)
mlflow.set_tracking_uri(f"file:{mlruns_dir}")        # was: "file:/content/mlruns"
mlflow.set_experiment("tourism-rf-vs-xgb")

# ----- model outputs: repo-relative too -----
output_dir = Path(os.getenv("OUTPUT_DIR", "outputs")).resolve()
output_dir.mkdir(parents=True, exist_ok=True)

rf_model_outpath  = output_dir / "rf_pipeline.joblib"     # was /content/...
